...
const App = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch('https://deprem-ihbar-backend.vercel.app/api/ihbar/yardim');
      console.log(res);
  ...
  const search = async (param) => {
    console.log(param)
    const response = await axios.get(`https://deprem-ihbar-backend.vercel.app/api/ihbar/yardim/search?name=${param}`);
